...
<aside class="notice">
<strong>Full Endpoint List</strong> — For all Core Service endpoints, see the Swagger UI at <code>http://localhost:8080/swagger/</code> and filter by <strong>Core Service</strong>.
</aside>
